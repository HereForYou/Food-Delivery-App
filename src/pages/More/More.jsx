  ...
  return (
    <div className='relative h-[812px]'>
      ...
      <div className='flex flex-col pl-[23px] pr-[21px] pt-[31px] pb-[124px] gap-[19px] justify-start'>
        <MoreItem iconType="income" iconColor="gray" linkTo="/more/payment-details"> Payment Details </MoreItem>
        <MoreItem iconType="shopping-bag" iconColor="gray" linkTo="/more/order"> My Orders </MoreItem>
        <MoreItem iconType="bell" iconColor="gray" linkTo="/more/notification"> 
          Notifications
        ...
        <MoreItem iconType="mail" iconColor="gray" linkTo="/more/inbox"> Inbox </MoreItem>
        <MoreItem iconType="info" iconColor="gray" linkTo="/more/aboutus"> About Us </MoreItem>
      </div>
      <Footer />
    </div>
  );
