...
const Intro = () => {
  ...
  if (pageNumber === 1) {
    ...
    content = (
      <span className="text-secondary text-[13px] mb-[60px] text-center">
  ...
  return (
    <div className="relative px-[21px] h-[790px] flex flex-col items-center">
      <div className="flex flex-col justify-end h-[385px]">{imgContent}</div>
      <div className="flex gap-[5px] my-8">
        <div
          className="border-[4px] rounded-[999px]"
          style={{ borderColor: pageNumber === 1 ? "#fc6011" : "#d6d6d6" }}
        />
        <div
          className="border-[4px] rounded-[999px]"
          style={{ borderColor: pageNumber === 2 ? "#fc6011" : "#d6d6d6" }}
        />
        <div
          className="border-[4px] rounded-[999px]"
          style={{ borderColor: pageNumber === 3 ? "#fc6011" : "#d6d6d6" }}
        />
      </div>
